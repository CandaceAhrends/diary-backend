...
const foodLookupUrl = (query, pageNumber) =>
  `https://api.nal.usda.gov/fdc/v1/foods/search?query='${encodeURIComponent(query)}'&pageSize=200&pageNumber=${pageNumber}&dataType=Branded,SR%20Legacy,Survey%20(FNDDS)&api_key=${process.env.USDA_API_KEY}`;
